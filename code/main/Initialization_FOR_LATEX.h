...
extern ColorSensor leftColor, rightColor, gripperColor, middleColor;
extern Motor topMotor, bottomMotor, leftMotor, rightMotor;
extern UltraSonic rightSonic, leftSonic, middleSonic;
extern MWServo arm, gripper;
extern Button button;
extern PIDController pid;
extern IRSensorArray irArray;

/**
 * Initializes the Infrared Sensor Array with predetermined calibration values.
 */
void initIRArray() {
...
/**
 * Initializes the motors with specified calibration data and configurations.
 */
void initMotors(){
...
/**
 * Initializes the button component by setting the designated pin mode.
 */
void initButtons(){
  button.pin = 36;
  button.initialize();
...
/**
 * Initializes the ultrasonic sensors, setting pin modes and default configurations.
 */
...
/**
 * Initializes the servo motors, configuring the default angles and speed settings.
 */
void initServos(){
...
/**
 * Initializes the PID controller used in the system.
 */
void initPID(){
  pid.initialize();
}
...
/**
 * Initializes color sensors, configuring them with frequency, pins, and label identifiers.
 */
